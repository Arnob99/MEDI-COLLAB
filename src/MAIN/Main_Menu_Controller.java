...
public class Main_Menu_Controller {
    @FXML private JFXListView<VBox> MainMenuActionPaneMainListView;
    @FXML private JFXButton MainMenuComposeButton;
    @FXML private JFXListView<VBox> MainMenuActionPaneTestResultListView;
    @FXML private JFXListView<VBox> MainMenuActionPanePrescriptionListView;
    ...
    @FXML private Label MainMenuActionPaneSetAppointmentsLabel;
    @FXML private Label MainMenuActionPaneAppointmentListLabel;
    ...
    public void handleMainMenuComposeButton() throws IOException, SQLException {
    ...
    public void handleRefreshButton() throws SQLException {
        ...
        Statement statement = Objects.requireNonNull(Medi_collab.connection()).createStatement(), statement1 = Objects.requireNonNull(Medi_collab.connection()).createStatement();
        ResultSet resultSet;
        ...
        MainMenuActionPanePrescriptionListView.setOnMouseClicked(mouseEvent -> {
        ...
        MainMenuActionPaneTestResultListView.setOnMouseClicked(mouseEvent -> {
    ...
    public void showSharingFiles(String username) throws SQLException {
        ...
        MainMenuActionPaneMainListView.setOnMouseClicked(mouseEvent -> {
            ...
            if (!flags.get(vBox)) {
                ...
                if(map2.get(vBox) != null) {
                    Blob blob = map2.get(vBox);
                    ...
                    imageView.fitWidthProperty().bind(MainMenuActionPaneMainListView.widthProperty().subtract(50));
...
//                    WritableImage writableImage = imageView.snapshot(snapshotParameters, null);
...
//                    imageView.setImage(writableImage);
                ...
                MainMenuActionPaneMainListView.refresh();
